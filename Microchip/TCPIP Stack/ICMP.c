...
LONG ICMPGetReply(void)
{
	...
	switch(ICMPState)
	{
		...
		case SM_ARP_SEND_QUERY:
                    if (StaticVars.ICMPRemote.IPAddr.v[3]!=255){
		...
		case SM_ARP_GET_RESPONSE:
			...
			if(!ARPIsResolved(&StaticVars.ICMPRemote.IPAddr, &StaticVars.ICMPRemote.MACAddr)&&(StaticVars.ICMPRemote.IPAddr.v[3]!=255))
				break;
                        else if (StaticVars.ICMPRemote.IPAddr.v[3]==255){
                            StaticVars.ICMPRemote.MACAddr.v[0]   = 0xff;
                            StaticVars.ICMPRemote.MACAddr.v[1]   = 0xff;
                            StaticVars.ICMPRemote.MACAddr.v[2]   = 0xff;
                            StaticVars.ICMPRemote.MACAddr.v[3]   = 0xff;
                            StaticVars.ICMPRemote.MACAddr.v[4]   = 0xff;
                            StaticVars.ICMPRemote.MACAddr.v[5]   = 0xff;
                        }
