...
//#define STACK_USE_CAN2TCP_BRIDGE		// CAN to TCP Bridge application example
 ...
 */
#define MY_DEFAULT_HOST_NAME			"FTCAL_LED_DRIVER"
 ...
 */
	...
	#define TCP_SOCKET_TYPES
		...
		#define TCP_PURPOSE_CAN_2_TCP_BRIDGE 12
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
			...
			{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 1800, 4710}, //200
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 25, 20},
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 25, 20},
			//{TCP_PURPOSE_BERKELEY_CLIENT, TCP_PIC_RAM, 125, 100},
			//{TCP_PURPOSE_CAN_2_TCP_BRIDGE, TCP_PIC_RAM, 1500, 1500},
		};
...
// -- Telnet Options -----------------------------------------------------
	...
	#define TELNET_USERNAME			"a"
	#define TELNET_PASSWORD			"a"
